...
import { Upload, Activity, AlertTriangle, CheckCircle, TrendingUp, DollarSign, PieChart, Wallet, FileText, ShieldCheck, Settings } from 'lucide-react';
...
function App() {
  ...
  return (
    <div className="flex h-screen bg-gray-50 overflow-hidden">
      {/* Sidebar */}
      <RailMenu activeTab={activeTab} setActiveTab={setActiveTab} />
          ...
          <div className="max-w-7xl mx-auto space-y-8 animate-fade-in-up">
                  ...
                  <div className="flex flex-col items-center justify-center min-h-[80vh] py-10">
                    <div className="text-center mb-10">
                      <h1 className="text-4xl font-extrabold text-gray-900 mb-4 tracking-tight">
                        Financial <span className="text-blue-600">Health Check</span>
                      </h1>
                      <p className="text-lg text-gray-500 max-w-2xl mx-auto">
                        AI-powered analysis for your company's financial stability, risk assessment, and growth opportunities.
                      </p>
                    </div>
            ...
            {activeTab === 'Analytics' && (
              <div className="flex flex-col items-center justify-center h-[60vh] text-center animate-fade-in-up">
                ...
                <p className="text-gray-500 mt-2">Deep dive into your financial metrics is coming soon.</p>
              </div>
            )}
            ...
            {activeTab === 'Reports' && (
              <div className="flex flex-col items-center justify-center h-[60vh] text-center animate-fade-in-up">
                ...
                <p className="text-gray-500 mt-2">Access all your historical financial health reports here.</p>
              </div>
            )}
